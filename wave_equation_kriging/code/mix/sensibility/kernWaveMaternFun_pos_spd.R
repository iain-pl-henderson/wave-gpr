...
cppFunction('
  ...
  NumericVector cppWave3D_pos_spd(NumericVector x1, NumericVector x2,
                                      NumericVector par);

  NumericVector cppWave3D_spd(NumericVector x1, NumericVector x2,
                                      NumericVector par);
  ...
  s2x1 = fmin(fabs(x1n) + x1_loc[3], R);
  s2x1 = s2x1 * s2x1;
  s2x2 = fmin(fabs(x2n) + x2_loc[3], R);
  s2x2 = s2x2 * s2x2;
  parK0[0] = par[5];
  parK0[1] = par[6];
  
  k11 = cppKernMatern5_2(s1x1, s1x2, parK0);
  k22 = cppKernMatern5_2(s2x1, s2x2, parK0);
  k12 = cppKernMatern5_2(s1x1, s2x2, parK0);
  k21 = cppKernMatern5_2(s2x1, s1x2, parK0);
  
  K = (k11 + k22 - k12 - k21)/ (16 * x1n * x2n * par[4] * par[4]);
  ...
  NumericVector par_pos(7), par_spd(7), K(1);
  ...
  K = cppWave3D_pos(x1,x2,par_pos) + cppWave3D_spd(x1,x2,par_spd);
  return(K);
  }')
